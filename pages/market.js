function WorkInProgressPopup() {
  ...
  function addProduct(name, description, price, file) {
    ...
    product.className = "elenco";
  
    let product_title = document.createElement("h1");
    product_title.innerHTML = name;
    product.className = "elenco_titolo";
    let product_description = document.createElement("h2");
    product_description.innerHTML(description);
    product.className = "elenco_description";
    let product_pay = document.createElement("div");
    product_pay.innerHTML = `Prezzo: <b>${price}</br>`;
  
    let btn = document.createElement("button");
    btn.className = "btn";
  }

  addProduct("Titolo", "Descrizione", "Prezzo")
